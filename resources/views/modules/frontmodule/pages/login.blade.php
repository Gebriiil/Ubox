    ...
    <div id="breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">@lang('frontmodule::front.login')</li>
            </ul>
        </div>
    </div>
    <!-- /BREADCRUMB -->
        ...
        <div class="container">
            <div class="row">
                <form method="POST" action="{{route('login')}}" id="content-login">
                    ...
                    <span>
                        <a href="#" class="d-inline small green dir-right">@lang('frontmodule::front.forgot_password')?</a>
                        <a href="{{ route('register') }}" class="d-inline small green space">@lang('frontmodule::front.register')</a>
			        </span>

                    <div class="row"><button type="submit" class="btn-login">@lang('frontmodule::front.login')</button></div>
                </form>
