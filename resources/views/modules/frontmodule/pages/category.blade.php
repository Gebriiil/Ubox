        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="aside" class="col-md-3">
                    ...
                    <!-- aside widget -->
                    <div class="aside">
                        <h3 class="aside-title">@lang('frontmodule::front.top_rated_product')</h3>
                        <!-- widget product -->
                        ...
                        @foreach($category->Paginationproducts() as $product)
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6 product_{{$product->id}}">
                                    <div class="product product-single">
                                        ...
                                        <div class="product-body">
                                            @if($product->offers and $product->offers->active == 1)
                                                <h3 class="product-price">{{offer_price($product)['offer_price']}}@lang('frontmodule::front.le') <del class="product-old-price">{{$product->sell_price}}@lang('frontmodule::front.le')</del></h3>
                                            @else
                                                <h3 class="product-price">{{$product->sell_price}} @lang('frontmodule::front.le')</h3>
                                            @endif
                                            <div class="product-rating">
