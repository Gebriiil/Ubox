...
<!-- BREADCRUMB -->
	...
	<div class="content-about">
		<div class="row bottom">
			...
			<h4>@lang('frontmodule::front.description_us')</h4>
			<p>@lang('frontmodule::front.description_us2')</p>
			</div>
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="service-space">
                       <img src="{{asset('public/img/truck.png')}}">
                        <h4>@lang('frontmodule::front.Free Shipping')</h4>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 service-block">
                    <div class="service-space">
                       ...
                       <img src="{{asset('public/img/support.png')}}">
                        <h4>@lang('frontmodule::front.Online Service')</h4>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 service-block">
                    <div class="service-space">
                      <img src="{{asset('public/img/24-hours-phone-service.png')}}">
                        <h4> @lang('frontmodule::front.Service') 24 </h4>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 service-block">
                    <div class="service-space">
                   <img src="{{asset('public/img/credit.png')}}">
                        <h4>@lang('frontmodule::front.Online Payment')</h4>
                    </div>
                </div>
            </div>
        </div>
