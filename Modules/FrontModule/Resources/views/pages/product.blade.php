                ...
                <div class="product product-details clearfix">
                    ...
                    <div class="col-md-6 product_{{ $product->id }}">
                        <div class="product-body">
                            ...
                            <div>
                                ...
                                <a href="#review_system">{{ $product->rating() }} @lang('frontmodule::front.reviews')</a>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="product-tab">
                            <ul class="tab-nav">
                                <li class="active dir-right"><a data-toggle="tab" href="#tab1">@lang('frontmodule::front.description')</a></li>
                                <li style=" {{lang() == 'ar' ? 'direction: rtl' : ''}}" ><a data-toggle="tab" href="#tab2">@lang('frontmodule::front.reviews') ({{ $product->reviews()->count() }})</a></li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div id="tab2" class="tab-pane fade in">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h4 class="text-uppercase">@lang('frontmodule::front.write_your_review')</h4>
                                            ...
                                            <form class="review-form" action="{{ route('setrate') }}" method="post" >
                                                ...
                                                <div class="form-group">
                                                    <div class="input-rating">
                                                        <strong class="text-uppercase">@lang('frontmodule::front.your_rating'): </strong>
                                                ...
                                                <button type="submit" class="primary-btn" id="butn">@lang('frontmodule::front.send')</button>
                                            </form>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="title">@lang('frontmodule::front.picked_for_you')</h2>
                    </div>
                </div>
                <!-- section title -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="product product-single">
                        <div class="product-thumb">
                            <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> @lang('frontmodule::front.quick_view')</button>
                            <img src="{{ $product->photo_path }}" alt="">
                        </div>
                        <div class="product-body">
                            @if($product->offers and $product->offers->active == 1)
                                <h3 class="product-price">
                                            {{offer_price($product)['offer_price']}}@lang('frontmodule::front.le') <del class="product-old-price">{{$product->sell_price}}@lang('frontmodule::front.le')</del></h3>
                            @else
                                <h3 class="product-price">{{$product->sell_price}} @lang('frontmodule::front.le')</h3>
                            @endif
