							...
							<div class="col-md-3 col-sm-6 col-xs-6 product_{{$offer->product->id}}">
                                    <div class="product product-single">
                                        <div class="product-thumb">
                                            <a href="{{route('only_product' , $offer->product->id)}}" class="main-btn quick-view"><i class="fa fa-search-plus"></i> @lang('uboxfrontmodule::front.quick_view')</a>
                                        ...
                                        <button style="{{checkInCart($offer->product->id)["style"]}}" class="product_{{$offer->product->id}} primary-btn add-to-cart" id="{{$offer->product->id}}"><i class="fa fa-shopping-cart"></i> {{checkInCart($offer->product->id)["status"] ? trans('uboxfrontmodule::front.added_to_cart') : trans('uboxfrontmodule::front.add_to_cart') }}</button>
