		...
		<div class="row">
			<div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-2 mb-5 text-center">
				...
				<form class="form-inline position-relative">
					<div class="form-group fables-subscribe-formgroup">
						<input type="email" class="form-control fables-subscribe-input fables-btn-rouned text-rtl" placeholder="Your Email">
					</div>
			...
			<div class="col-12 col-lg-4 mb-4 mb-lg-0">
				...
				<p class="font-15 fables-third-text-color">
					The company was established in 2019 to include various departments to serve the business sector and individuals in different fields through applications aimed at the happiness and satisfaction of customers.
				</p>

			</div>

			<div class="col-12 col-sm-6 col-lg-4">
				<h2 class="font-20 semi-font fables-second-border-color border-bottom pb-3 text-rtl">Contact us</h2>
				<div class="my-3">
