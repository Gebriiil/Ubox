...
use Modules\UboxFrontModule\Entities\Testmonials;
...
class FrontModuleController extends Controller {
	...
	public function sendToContact() {
		...
		Mail::to('Wieboxsol@gmail.com')->send(new ContactUs([
			'email' => request('email'),
	...
	public function about_us() {
		...
		$testmonials = Testmonials::latest()->limit(2)->get();

		return view('uboxfrontmodule::pages.about', compact('categories', 'page_name', 'testmonials'));
	}
	...
	public function index() {
		...
		return view('uboxfrontmodule::index', compact('categories', 'news', 'testmonials'));
	}
