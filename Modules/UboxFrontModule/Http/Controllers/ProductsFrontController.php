...
class ProductsFrontController extends Controller {
	...
	public function product($id) {
		...
		return view('uboxfrontmodule::pages.product', compact('categories', 'product', 'productInCart', 'page_name', 'PickedForYou'));
	}
	...
	public function product_search() {
		...
		return view('uboxfrontmodule::pages.product_search', compact('products', 'page_name'));
	}
