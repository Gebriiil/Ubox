...
@section('title')
  @lang('blogmodule::blog.create_blog')
@endsection
...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">{{__('blogmodule::blog.create_blog')}}</h3>
    </div>
    @if (count($errors) > 0)
    ...
    <form class="form-horizontal" action="{{url('/admin-panel/blog')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="box-body">
        ...
        {{-- Upload photo --}}
        <div class="form-group">
          <label class="control-label col-sm-2" for="photo">3{{__('blogmodule::blog.photo')}} :</label>
          <div class="col-sm-4">
