...
@section('title')
  @lang('projectmodule::project.create_category')
@endsection
...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">{{__('projectmodule::project.create_category')}}</h3>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{url('/admin-panel/jobs-category')}}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" class="form-control"
                      placeholder="Write Title" name="{{ $locale }}[name]" >
                  </div>
                </div>
