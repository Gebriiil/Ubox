    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          {{-- Add New --}}
          <a href="{{url('admin-panel/jobs-category/create')}}" type="button" class="btn btn-success pull-right">
              ...
              <table id="adminsTable" class="table table-bordered table-hover">
                  ...
                  @foreach ($categories as $category)
                      <tr>
                          ...
                          <td>
                              {{-- Edit --}}
                              <a title="Edit" href="{{ url('admin-panel/jobs-category/' . $category->id . '/edit')}}" type="button" class="btn btn-primary">
                                  <i class="fa fa-pencil" aria-hidden="true"></i>
                              </a>
                              {{-- Delete --}}
                              <form class="inline" action="{{  url('admin-panel/jobs-category/' . $category->id)}}" method="POST">
